"""Portable, vendor-agnostic classifiers for the distress-motivation upgrade.

Copied verbatim from county-records/scripts/classify.py. Skills are
self-contained (no cross-skill imports), so the motivation Layer 2 path carries
its own copy. Pure functions, no I/O.
