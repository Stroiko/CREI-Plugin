...
| Tarrant/Bexar/Collin/Denton/Hidalgo/Cameron, TX | GovOS app identical to Dallas (fingerprint) | expected same | expected owner-lookup on county CAD | Candidates (verify next) |
