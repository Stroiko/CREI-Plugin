...
| DeKalb, GA | ✓ (13/2wk; **Landmark but NO reCAPTCHA** — fully open; XLSX export) | ✓ labeled tokens with a **direct Parcel** (DIS/LAND/LOT/SUB/Parcel/address) | **direct-parcel** on DeKalb Tax Commissioner (iasWorld) | **Verified (3/3)** — 2026-08-24. Vendor = Landmark; no case numbers |
| Cobb/Cherokee, GA | Landmark, expected open like DeKalb | expected labeled+parcel | direct-parcel (parcel format + appraiser differ) | Candidates (verify next) |
